...
* Community maintained respins \(updated packages\) ****[https://dl.fedoraproject.org/pub/alt/live-respins/](https://dl.fedoraproject.org/pub/alt/live-respins/)
* Official Release ISO ****[https://getfedora.org/en/workstation/download/](https://getfedora.org/en/workstation/download/)

### Step 2: Upgrade immediately after installing
...
{% hint style="warning" %}
This is a bad practice, but not critical. I disable it because I don't know how to use it.
{% endhint %}
...
* Google Chrome
  ...
  * Source: [https://fedoraproject.org/wiki/Workstation/Third\_Party\_Software\_Repositories](https://fedoraproject.org/wiki/Workstation/Third_Party_Software_Repositories)
  * Enable `chrome://flags/#allow-insecure-localhost` for self-signed SSH to work locally
...
* Misc
  ...
  * pv needed for some bash scripts.Remmina for remoting into windows machine.pavucontrol audio volume troubleshootingqt5-qtsvg required for flameshot's icons to work \(since Fedora 30\)meld is a diff merge toollsyncd directory live-sync toolShellCheck is shell code analysis tool, gives great tips, kind of like linting

  ```text
  sudo dnf install -y tilix flameshot qt5-qtsvg htop remmina pv nano gnome-tweaks pavucontrol util-linux-user parallel jq meld ack lsyncd svn ShellCheck dnf-plugins-core
  ```
